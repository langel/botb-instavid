...
ffmpeg -i assets/background.png -thread_queue_size 64 -loop 1 -i assets/avatar500-%03d.png -i assets/battle-art300-%03d.png -i assets/format-icon96-%03d.png -thread_queue_size 64 -loop 1 -r 15 -i assets/botblogo-%01d.png -i assets/title.png -i assets/format-title.png -i assets/battle-time.png -i assets/mp3 -filter_complex "
...
[base][bg] overlay=y=-'((t+1)/$length)*(h-H)*0.1' [tmp1];
[tmp1][avatar] overlay=1:x=108:y=108 [tmp2];
[tmp2][battle] overlay=1:x=1512:y=408 [tmp3];
[tmp3][format] overlay=1:x=716:y=462 [tmp4];
[tmp4][botblogo] overlay=1:x=108:y=780 [tmp5];
[tmp5][title] overlay=1:x=716:y=108 [tmp6];
[tmp6][format_title] overlay=1:x=804:y=480 [tmp7];
[tmp7][battle_time] overlay=1:x=716:y=608
